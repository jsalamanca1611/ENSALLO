/* ============================================================
   CONTACTO.JS — Formulario flotante para contactar a un asesor.
   El formulario se escribe UNA sola vez aquí y se inserta solo
   en cualquier página que incluya este archivo, así no se repite
   el mismo HTML en cada página. El enlace "Contacto" del menú
   llama a abrirContacto().
   ============================================================ */

// Se agrega el formulario al final de la página
  ...
  <div class="fondo-modal" id="fondo-contacto" onclick="cerrarContacto()">
    <div class="modal" onclick="event.stopPropagation()">
      ...
      <div class="campo">
        ...
        <input type="tel" placeholder="Ej: 300 123 4567">
      </div>
      <div class="campo">
        <label>Correo electrónico</label>
        <input type="email" placeholder="Ej: maria@correo.com">
      </div>
      <div class="campo">
        <label>Mensaje</label>
...
// Una vez insertado, guardamos la referencia para abrir/cerrar
